...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <main className="pt-24 md:pt-40">
        ...
        <section id="sobre" className="relative py-12 md:py-20 bg-[#0A0F1C]/50 border-t border-secondary/20 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            {/* =========================================
                VERSÃO MOBILE DA SEÇÃO SOBRE (NOVO LAYOUT COM FOTO NA DIREITA)
            ========================================= */}
            <div className="flex md:hidden flex-col w-full gap-4">
              
              {/* Parte Superior: (Título e Parágrafo 1) na Esquerda + Imagem na Direita */}
              <div className="flex flex-row items-start gap-4 w-full">
                
                {/* Coluna Esquerda: Título + 1º Parágrafo */}
                <div className="flex flex-col flex-1 pt-1">
                  <h2 className="text-[22px] sm:text-3xl font-bold text-white leading-[1.2] mb-3">
                ...
                {/* Imagem (Mantida nos 20% maiores, agora na direita) */}
              ...
              {/* Parte Inferior: Parágrafo 2 e Cards */}
              <div className="flex flex-col w-full mt-2">
                  <p className="text-slate-400 text-[14px] sm:text-[15px] leading-relaxed mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-5">
                    <div className="glitch-border-1 bg-[#070B14]/80 backdrop-blur-sm border border-primary/20 p-3 rounded-lg flex flex-col md:flex-row items-start justify-start gap-2 hover:border-primary/60 transition-colors">
      ...
      {/* BOTÃO FLUTUANTE DO WHATSAPP REDUZIDO NO MOBILE */}
      <div className="fixed bottom-3 left-3 md:bottom-6 md:left-6 z-[9999]">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="whatsapp-float matrix-glitch block bg-[#25D366] text-[#070B14] p-2 md:p-4 rounded-full flex items-center justify-center group shadow-xl"
